...
if appliance_df.empty:
    ...
    if len(y.unique()) < 2:
        st.warning("Not enough usage variation to train model.")
    else:
        # Train/test split
        ...
        if 'prediction_result' in st.session_state:
            ...
            st.success("✅ Prediction: Will be used" if result else "❌ Prediction: Not likely used")
            st.write("Raw Prediction Value:", result)
...
# streamlit run "C:\Users\Akash\Desktop\electricity3\behaviour_learn\app2.py"